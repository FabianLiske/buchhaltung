...
public:
    ...
    WorkDetails create_work(const WorkCreate& create) const;
    EditionDetails create_edition(const EditionCreate& create) const;
    CopyDetails create_copy(const CopyCreate& create) const;
